...
class Page {
    ...
    public function loadBySlug($slug) {
        ...
        return $this->decodePageRow($page);
    }

    public function loadContentBySlug($slug) {
        $page = $this->loadBySlug($slug);
    ...
    public function createDecoded($title, $slug, array $content) {
        return $this->decodePageRow($this->create($title, $slug, $content));
    }
    ...
    public function updateDecoded($id, $title, $slug, array $content) {
        return $this->decodePageRow($this->update($id, $title, $slug, $content));
    }
    ...
    public function saveContentBySlug($slug, array $content, $title = null) {
        return $this->decodePageRow($this->saveBySlug($slug, $content, $title));
    }
    ...
    public function loadOrCreateBySlug($slug, $title, array $defaultContent) {
        return $this->decodePageRow($this->getOrCreateBySlug($slug, $title, $defaultContent));
    }
    ...
    private function decodePageRow($page) {
        if (!$page) {
            return null;
        }
