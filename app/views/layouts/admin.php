...
<body>
    <?php if (isset($_SESSION['admin_id']) && $_SERVER['REQUEST_URI'] != '/admin'): ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(135deg, #2D5A27 0%, #4A7C59 100%) !important;">
            <div class="container">
                <a class="navbar-brand" href="<?php echo URL_ROOT; ?>/admin/pages">HeypVietNam Admin</a>
                ...
                <div class="collapse navbar-collapse" id="navbarAdmin">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link <?= strpos($_SERVER['REQUEST_URI'], '/admin/pages') !== false ? 'active' : '' ?>" href="<?php echo URL_ROOT; ?>/admin/pages">
                                <i class="fas fa-file-lines"></i> Landing page
                            </a>
                        </li>
                    </ul>
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="<?php echo URL_ROOT; ?>" target="_blank"><i class="fas fa-home"></i> Xem trang chủ</a></li>
